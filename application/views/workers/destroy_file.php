...
<div class="box box-solid bg-yellow">
  <div class="box-header with-border">
    <h3 class="box-title"><span class="khmer_font">លប់ឬបំប្លាញឯកសារពាក់ព័ន្ធ</span> &#921; Destroy or Permanently Delete related docs of Worker  </h3>
  </div>
</div>
<form method="post">
<div class="row">
...
<div class="box box-solid bg-red">
  ...
  <div class="box-body">
      <div class="form-group row">
          ...
          <input type="hidden" name="worker_id" value="<?php echo $attachment['worker_id']; ?>">
