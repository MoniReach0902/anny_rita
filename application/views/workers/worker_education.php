...
<section class="bg-hexagons-dark">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($educationw['geducation'])) {
                    $educationw['geducation'] = NULL;
                } ?>
                <select class="custom-select form-control" id="geducation" name="geducation">
                    ...
                    <?php foreach ($educations as $education) { ?>
                        <option value="<?php echo $education['id']; ?>" <?php echo ($education['id'] == $educationw['geducation']) ? 'selected' : ''; ?>>
                            <?php if (!isset($educationw['k_label'])) {
                                $educationw['k_label'] = NULL;
                            } ?><?php if (!isset($educationw['e_label'])) {
                                                                                                                $educationw['e_label'] = NULL;
                                                                                                            } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($educationw['skill'])) {
                    $educationw['skill'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($educationw['level'])) {
                    $educationw['level'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($educationw['vocat'])) {
                    $educationw['vocat'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($educationw['vocalevel'])) {
                    $educationw['vocalevel'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <?php if (!isset($educationw['drivelic'])) {
                    $educationw['drivelic'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <?php if (!isset($educationw['flanguage'])) {
                    $educationw['flanguage'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php if (!isset($educationw['flanguage_yes_no'])) {
                    $educationw['flanguage_yes_no'] = NULL;
                } ?>
