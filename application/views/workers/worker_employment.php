    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['wage'])) {
                    $employment['wage'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['currency'])) {
                    $employment['currency'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['contract_start_date'])) {
                    $employment['contract_start_date'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['contract_end_date'])) {
                    $employment['contract_end_date'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['departure_date'])) {
                    $employment['departure_date'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['working_date'])) {
                    $employment['working_date'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['return_date'])) {
                    $employment['return_date'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['pre_depart_date'])) {
                    $employment['pre_depart_date'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['lang_start_date'])) {
                    $employment['lang_start_date'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['lang_end_date'])) {
                    $employment['lang_end_date'] = NULL;
                } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['signing_manpow_date'])) {
                    $employment['signing_manpow_date'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($employment['signing_workin_date'])) {
                    $employment['signing_workin_date'] = NULL;
                } ?>
