        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control " name="affiliate" id="affiliate">
                    <?php if (!isset($worker['affiliate'])) {
                        $worker['affiliate'] = NULL;
                    } ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php if (!isset($worker['religion'])) {
                    $worker['religion'] = NULL;
                } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="custom-select form-control " id="job_title" name="job_title">
                    <?php if (!isset($worker['job_title'])) {
                        $worker['job_title'] = NULL;
                    } ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="custom-select form-control " id="industry" name="industry">
                    <?php if (!isset($worker['industry'])) {
                        $worker['industry'] = NULL;
                    } ?>
