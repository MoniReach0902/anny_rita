        ...
        <div class="box box-solid bg-dark">
            ...
            <div class="box-body">
                ...
                <section class="invoice printableArea">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="<?php echo base_url('images/1.png') ?>" alt="" width="98%">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h3 style="text-align: center;font-family: 'Khmer OS Muol Light';font-size: 22px;">
                                ...
                                <br>
                                ឱ្យអនុវត្តបទដ្ឋានអប្បបរមាស្តីពីកិច្ចសន្យាសេវារការងារឱ្យធ្វើនៅបរទេស
                            </h3>
                            <h3 style="text-align: center;font-family: 'Khmer OS Muol Light';font-size: 22px;">
                                បទដ្ឋានអប្បបរមា
                            </h3>
                            <h3 style="text-align: center;font-family: 'Khmer OS Muol Light';font-size: 22px;">
                                ...
                                ស្តីពី<br>
                                កិច្ចសន្យាសេវារកការងារឱ្យធ្វើ សម្រាប់ពលករខ្មែរទៅធ្វើការនៅប្រទេសថៃ
                    ...
                    <br>
                    <div class="row" style="font-family: 'Khmer OS Battambang'; line-height: 36px;">
                        <div class="col-md-12">
                            <p style="font-size: 23px;text-align: center;">កិច្ចសន្យានេះធ្វើឡើងរវាង</p>
                            <p style="font-size: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ក្រុមហ៊ុន<span style="text-decoration-line: underline; font-family: 'Khmer OS Muol Light">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;អាន់នី រីតា បេស មេនផៅវ័រ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                អាសយដ្ឋានផ្ទះលេខ
                                <span style="text-decoration-line: underline; font-family: 'Khmer OS Muol Light'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;៣២-៣៣អឺ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> ផ្លូវ
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;&nbsp;វេងស្រេង&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> ឃុំ/សង្កាត់
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;&nbsp;ចោមចៅ&nbsp;&nbsp;&nbsp;&nbsp;</span> ស្រុក/ខណ្ឌ/ក្រុង
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;&nbsp;ពោធិ៍សែនជ័យ&nbsp;&nbsp;&nbsp;&nbsp;</span> ខេត្ត/រាជធានី
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;&nbsp;ភ្នំពេញ&nbsp;&nbsp;&nbsp;&nbsp; </span> ព្រះរាជាណាចក្រកម្ពុជា ដែលទទួលបានការអនុញ្ញាតតាមប្រកាសលេខ
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp; ១២៦/២០&nbsp;&nbsp;&nbsp;</span> ចុះថ្ងៃទី
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;៣០&nbsp;&nbsp;&nbsp;</span> ខែ
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;មីនា&nbsp;&nbsp;&nbsp;</span>ឆ្នាំ
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;២០២០&nbsp;&nbsp;&nbsp;</span>មានលោក/លោកស្រី
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;សុខ ចំណាន&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>មានតួនាទី/ភារកិច្ចជា
                                <span style="text-decoration-line: underline;
                                font-family: 'Khmer OS Muol Light'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;អគ្គនាយកក្រុមហ៊ុន&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> ជាអ្នកតំណាង ចាប់ពីពេលនេះតទៅ ហៅថា
                                <span style="font-family: 'Khmer OS Muol Light';
                                ">«ភាគីទីភ្នាក់ងារជ្រើសរើសឯកជន»</span> និង
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row" style="font-family: 'Khmer OS Battambang'; line-height: 37px;">
                        <div class="col-md-12">
                            <p style="font-weight: bold; text-align: center;font-size: 20px;">
                                ភាគីទាំងពីរបានឯកភាព និងព្រមព្រៀងគ្នាដូចតទៅ ៖
                            </p>
                            <h4 style="text-align: center;font-size: 19px; font-family: 'Khmer OS Muol Light';">ផ្នែកទី១ <br>
                                <br> បទប្បញ្ញត្តិទូទៅ
                            </h4>
