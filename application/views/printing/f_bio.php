					...
					<div class="row">
						<div class="col-12">
							<div class="khmer_font_bio">
								...
								ថ្ងៃខែឆ្នាំកំណើតថ្ងៃទី ...<b><?php $datee = $worker['dob'];
																echo (date('d', strtotime($datee))); ?></b>... ខែ ...<b><?php echo (date('m', strtotime($datee))); ?></b>... ឆ្នាំ ...<b><?php $byear = (date('Y', strtotime($datee)));
																																																					echo $byear; ?></b>... អាយុ ...<?php $datey = date('Y');
																																																																									echo $datey - $byear; ?> ... ជនជាតិ ....<b><?php echo ($worker['race'] == 'Khmer') ? 'ខ្មែរ' : ''; ?></b>... សញ្ជាតិ ...<b><?php echo ($worker['nationality'] == 'Khmer') ? 'ខ្មែរ' : ''; ?></b>... <br /><br />
								...
								ខេត្ត/ក្រុង ...<b><?php echo (isset($pro_namec['name'])) ? $pro_namec['name'] : ''; ?>...
									...
									<span class="bio_m60"><i class="fa fa-<?php //echo ($flang['flanguage'] == 'jp') ? 'check-' : ''; 
																			?>square-o" aria-hidden="true"></i> ជប៉ុន </span><br /><br />
