                ...
                <section class="invoice printableArea">
                    ...
                    <div class="content-box" style="margin-top: 10px;">
                        ...
                        <div class="content-center">
                            ...
                            <p style="text-align: justify;">ប្រកាសលេខ ០១៣/១៥ ក.ប/ប្រ.ក ចុះថ្ងៃទី១៣ ខែកក្កដា ឆ្នាំ២០១៥ របស់ក្រសួងការងារ និងបណ្តុះបណ្តាលវិជ្ជាជីវៈ ស្តីពីការអនុញ្ញាតឱ្យក្រុមហ៊ុន <span>អាន់នី រីតា បេស មេនផៅវ័រ</span> ធ្វើការជ្រើសរើស បណ្តុះបណ្តាល បញ្ជូន និងគ្រប់គ្រងពលករ-ពលការិនីខ្មែរទៅធ្វើការនៅព្រះរាជាណាចក្រថៃឡង់ដ៏។</p>
                        </div>
