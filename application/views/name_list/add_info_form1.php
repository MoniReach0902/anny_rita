                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="arm_num" placeholder="ARM Number" id="kdkdk" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="date" placeholder="Name List" id="kdkdk" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="month" placeholder="Name List" id="kdkdk" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="year" placeholder="Name List" id="kdkdk" value="">
                            </div>
                        </div>
                        <div class="form-group row">
