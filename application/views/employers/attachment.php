...
<div class="box box-solid bg-dark">
  <div class="box-header with-border">
    <h3 class="box-title"><span class="khmer_font">បង្ហាញាឯកសារពាក់ព័ន្ធ</span> &#921; Showing All related docs  </h3>
  </div>
</div>
<div class="row">
	<div class="col-3">
	...
	<div class="col-6">
<?php if(empty($attachments)) { echo "No Attachment found for this Employer ID"; } ?>
...
<div class="box box-solid bg-dark">
  ...
  <div class="box-body">
	  ...
	  <div class="form-group row">
        ...
        <div class="col-sm-2">
          <a class="dropdown-item" href="<?php echo site_url('employers/destroy_file/' . $attachment['id']); ?>"><span class="text-danger">Delete This File</span></a>
        </div>
      </div>
  </div>
  <!-- /.box-body -->			
...
<?php echo form_open_multipart('');?>
    ...
    <div class="form-group row">
            <div class="box box-solid bg-dark">
            <div class="box-header with-border">
              <h5 class="box-title"><span class="khmer_font">ឯកសារបន្ថែម </span> &#921; Add more Ref Doc</h5>					  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
