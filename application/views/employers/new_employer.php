        ...
        <div class="row">
          ...
          <div class="col-6">
            ...
            <div class="form-group row" style="display: none;">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['empl_id'])) {
                  $employer['empl_id'] = NULL;
                } ?>
            ...
            <div class="form-group row">
              ...
              <?php if (!isset($employer['k_name'])) {
                $employer['k_name'] = NULL;
              } ?>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['e_name'])) {
                  $employer['e_name'] = NULL;
                } ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['ab_name'])) {
                  $employer['ab_name'] = NULL;
                } ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['mobile'])) {
                  $employer['mobile'] = NULL;
                } ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['email'])) {
                  $employer['email'] = NULL;
                } ?>
                <input class="form-control" type="text" name="email" placeholder="Email" value="<?php if (!empty($employer['email'])) {
                                                                                                  echo $employer['email'];
                                                                                                } else {
                                                                                                  echo "armworkers@gmail.com ";
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['business_industry'])) {
                  $employer['business_industry'] = NULL;
                } ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <?php if (!isset($employer['worker_total'])) {
                  $employer['worker_total'] = NULL;
                } ?>
              ...
              <div class="col-sm-3">
                <?php if (!isset($employer['worker_f'])) {
                  $employer['worker_f'] = NULL;
                } ?>
              ...
              <div class="col-sm-3">
                <?php if (!isset($employer['worker_m'])) {
                  $employer['worker_m'] = NULL;
                } ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <?php if (!isset($employer['description'])) {
