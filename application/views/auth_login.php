...
<head>
  <meta charset="utf-8">
    ...
    <title>Anny Rita - Authentication Login </title>
  
	<!-- Vendors Style-->
	<link rel="stylesheet" href="<?php echo base_url('public/css/vendors_css.css'); ?>">
	  
	<!-- Style-->    
	<link rel="stylesheet" href="<?php echo base_url('public/css/horizontal-menu.css'); ?>"> 
	<link rel="stylesheet" href="<?php echo base_url('public/css/style.css'); ?>">
	<link rel="stylesheet" href="<?php echo base_url('public/css/skin_color.css'); ?>">

</head>
	
<body class="hold-transition theme-primary bg-img" style="background-image: url(<?php echo base_url('images/bg-1.jpg'); ?>)">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								<h2 class="text-primary">Let's Get Started with</h2>
								<p class="mb-0">Sign in to continue to Arita Admin Dashboard.</p>							
							</div>
							<div class="p-40">
								<form method="post">
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Don't have an account? <a href="<?php echo site_url('Login/signup'); ?>" class="text-warning ms-5">Sign Up</a></p>
								</div>	
							</div>						
						</div>
					</div>
